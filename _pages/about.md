...
title: about
permalink: /
subtitle: Technical Writing. API Documentation. UX Writing. Content Architecture.
...
<div class="featured-ride">
  <div style="position: relative; padding-bottom: 80%; height: 0; overflow: hidden; max-width: 250px; margin: 0 auto; border-radius: 12px; box-shadow: 0 8px 32px rgba(0,0,0,0.35);">
    <iframe
